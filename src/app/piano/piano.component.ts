...
@Component({
  ...
  animations: [
    trigger('whiteKeyDownUp', [
      ...
      transition('up => down', [animate('0.1s')]),
      transition('down => up', [animate('0.2s')]),
    ]),
...
export class PianoComponent implements OnInit {
  ...
  public blacks = [];
  public inputs: Input[] = [];
  public MIDIInputName = 'Roland Digital Piano';
  ...
  constructor(
    ...
    this.notesSubscription = this.pianoService.notesSource.subscribe(notes => {
      this.notes = notes;
    });
